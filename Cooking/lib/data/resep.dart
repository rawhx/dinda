...
List<resep> dataResep = [
  resep(
      name: 'Yuk cegah covid sekarang jugaa!!!',
      htm: '',
      tutorial:
      ...
      image: 'cegah.jpg'),
  resep(
      name: 'Manfaat Minum Air Hangat Dipagi hari',
      htm: '',
      tutorial:
      ...
      image: 'air_hangat.jpg'),
  resep(
      name: 'Simak Makanan untuk ibu hamil',
      htm: '',
      tutorial:
